    ...
    return (
      <div>
        ...
        <div className="container-fluid">
            <a className="navbar-brand" href="/">NewsTak</a>
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <a a className="nav-link active" aria-current="page" href="/">Home</a></li>
                <li className="nav-item"><a a className="nav-link" href="/">About</a></li>
